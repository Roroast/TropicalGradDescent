...
Stats_Prob = "WDinf"
WDinf_lr_DF =  make_DF(t_dim_list, num_exps = 10, lr_df = None, Stats_Prob = Stats_Prob)
WDinf_lr_DF = WDinf_lr_DF.merge(lr_list_DF, how = "cross")
...
tic = time.time()
lr_training(loss_function, WDinf_lr_DF, Stats_Prob = Stats_Prob)
print("WDinf lr time: ", (time.time() - tic)/60, " minutes")
WDinf_lr_DF['loss'] = WDinf_lr_DF['loss_values'].str[-1]

WDinf_lr_DF.to_pickle("DataFrames/WDinf_lr_DF.pkl")