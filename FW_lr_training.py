...
Stats_Prob = "FW"
FW_lr_DF =  make_DF(t_dim_list, num_exps = 10, lr_df = None, Stats_Prob = Stats_Prob)
FW_lr_DF = FW_lr_DF.merge(lr_list_DF, how = "cross")
...
tic = time.time()
lr_training(loss_function, FW_lr_DF, Stats_Prob=Stats_Prob)
print("FW lr time: ", (time.time() - tic)/60, " minutes")
FW_lr_DF['loss'] = FW_lr_DF['loss_values'].str[-1]

FW_lr_DF.to_pickle("DataFrames/FW_lr_DF.pkl")